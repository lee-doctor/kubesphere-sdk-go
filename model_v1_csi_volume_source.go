...
type _V1CSIVolumeSource V1CSIVolumeSource
...
func (o *V1CSIVolumeSource) UnmarshalJSON(data []byte) (err error) {
	...
	varV1CSIVolumeSource := _V1CSIVolumeSource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1CSIVolumeSource)

	if err != nil {
		return err
	}

	*o = V1CSIVolumeSource(varV1CSIVolumeSource)
