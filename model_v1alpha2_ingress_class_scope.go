...
// checks if the V1alpha2IngressClassScope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha2IngressClassScope{}

// V1alpha2IngressClassScope struct for V1alpha2IngressClassScope
type V1alpha2IngressClassScope struct {
	...
	Spec *V1alpha2IngressClassScopeSpec `json:"spec,omitempty"`
...
func NewV1alpha2IngressClassScope() *V1alpha2IngressClassScope {
	this := V1alpha2IngressClassScope{}
	return &this
}
...
func (o *V1alpha2IngressClassScope) GetSpec() V1alpha2IngressClassScopeSpec {
	if o == nil || IsNil(o.Spec) {
		var ret V1alpha2IngressClassScopeSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given V1alpha2IngressClassScopeSpec and assigns it to the Spec field.
...
func (o V1alpha2IngressClassScope) MarshalJSON() ([]byte, error) {
...
func (o V1alpha2IngressClassScope) ToMap() (map[string]interface{}, error) {
...
type NullableV1alpha2IngressClassScope struct {
	value *V1alpha2IngressClassScope
	isSet bool
}

func (v NullableV1alpha2IngressClassScope) Get() *V1alpha2IngressClassScope {
	return v.value
}

func (v *NullableV1alpha2IngressClassScope) Set(val *V1alpha2IngressClassScope) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha2IngressClassScope) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha2IngressClassScope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha2IngressClassScope(val *V1alpha2IngressClassScope) *NullableV1alpha2IngressClassScope {
	return &NullableV1alpha2IngressClassScope{value: val, isSet: true}
}

func (v NullableV1alpha2IngressClassScope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha2IngressClassScope) UnmarshalJSON(src []byte) error {
	v.isSet = true
