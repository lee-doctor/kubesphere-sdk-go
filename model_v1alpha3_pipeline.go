...
// checks if the V1alpha3Pipeline type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha3Pipeline{}

// V1alpha3Pipeline struct for V1alpha3Pipeline
type V1alpha3Pipeline struct {
	...
	Spec *V1alpha3PipelineSpec `json:"spec,omitempty"`
...
// SetSpec gets a reference to the given V1alpha3PipelineSpec and assigns it to the Spec field.
...
func (o V1alpha3Pipeline) MarshalJSON() ([]byte, error) {
...
func (o V1alpha3Pipeline) ToMap() (map[string]interface{}, error) {
...
type NullableV1alpha3Pipeline struct {
	value *V1alpha3Pipeline
	isSet bool
}

func (v NullableV1alpha3Pipeline) Get() *V1alpha3Pipeline {
	return v.value
}

func (v *NullableV1alpha3Pipeline) Set(val *V1alpha3Pipeline) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha3Pipeline) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha3Pipeline) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha3Pipeline(val *V1alpha3Pipeline) *NullableV1alpha3Pipeline {
	return &NullableV1alpha3Pipeline{value: val, isSet: true}
}

func (v NullableV1alpha3Pipeline) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha3Pipeline) UnmarshalJSON(src []byte) error {
	v.isSet = true
