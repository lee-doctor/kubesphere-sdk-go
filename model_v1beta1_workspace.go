...
// checks if the V1beta1Workspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1beta1Workspace{}

// V1beta1Workspace struct for V1beta1Workspace
type V1beta1Workspace struct {
...
func (o V1beta1Workspace) MarshalJSON() ([]byte, error) {
...
func (o V1beta1Workspace) ToMap() (map[string]interface{}, error) {
...
type NullableV1beta1Workspace struct {
	value *V1beta1Workspace
	isSet bool
}

func (v NullableV1beta1Workspace) Get() *V1beta1Workspace {
	return v.value
}

func (v *NullableV1beta1Workspace) Set(val *V1beta1Workspace) {
	v.value = val
	v.isSet = true
}

func (v NullableV1beta1Workspace) IsSet() bool {
	return v.isSet
}

func (v *NullableV1beta1Workspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1beta1Workspace(val *V1beta1Workspace) *NullableV1beta1Workspace {
	return &NullableV1beta1Workspace{value: val, isSet: true}
}

func (v NullableV1beta1Workspace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1beta1Workspace) UnmarshalJSON(src []byte) error {
	v.isSet = true
