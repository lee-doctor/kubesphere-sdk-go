...
type _V1ScaleIOVolumeSource V1ScaleIOVolumeSource
...
func (o *V1ScaleIOVolumeSource) UnmarshalJSON(data []byte) (err error) {
	...
	varV1ScaleIOVolumeSource := _V1ScaleIOVolumeSource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1ScaleIOVolumeSource)

	if err != nil {
		return err
	}

	*o = V1ScaleIOVolumeSource(varV1ScaleIOVolumeSource)
