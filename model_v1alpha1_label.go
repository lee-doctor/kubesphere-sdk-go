...
// checks if the V1alpha1Label type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1Label{}

// V1alpha1Label struct for V1alpha1Label
type V1alpha1Label struct {
	...
	Spec V1alpha1LabelSpec `json:"spec"`
}

type _V1alpha1Label V1alpha1Label
...
func (o V1alpha1Label) MarshalJSON() ([]byte, error) {
...
func (o V1alpha1Label) ToMap() (map[string]interface{}, error) {
...
func (o *V1alpha1Label) UnmarshalJSON(data []byte) (err error) {
	...
	varV1alpha1Label := _V1alpha1Label{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1alpha1Label)

	if err != nil {
		return err
	}

	*o = V1alpha1Label(varV1alpha1Label)

	return err
}

type NullableV1alpha1Label struct {
	value *V1alpha1Label
	isSet bool
}

func (v NullableV1alpha1Label) Get() *V1alpha1Label {
	return v.value
}

func (v *NullableV1alpha1Label) Set(val *V1alpha1Label) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha1Label) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha1Label) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha1Label(val *V1alpha1Label) *NullableV1alpha1Label {
	return &NullableV1alpha1Label{value: val, isSet: true}
}

func (v NullableV1alpha1Label) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha1Label) UnmarshalJSON(src []byte) error {
	v.isSet = true
