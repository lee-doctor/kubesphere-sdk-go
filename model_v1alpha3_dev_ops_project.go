...
// checks if the V1alpha3DevOpsProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha3DevOpsProject{}

// V1alpha3DevOpsProject struct for V1alpha3DevOpsProject
type V1alpha3DevOpsProject struct {
	...
	Status *V1alpha3DevOpsProjectStatus `json:"status,omitempty"`
}
...
func (o *V1alpha3DevOpsProject) GetStatus() V1alpha3DevOpsProjectStatus {
	if o == nil || IsNil(o.Status) {
		var ret V1alpha3DevOpsProjectStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given V1alpha3DevOpsProjectStatus and assigns it to the Status field.
func (o *V1alpha3DevOpsProject) SetStatus(v V1alpha3DevOpsProjectStatus) {
	o.Status = &v
}

func (o V1alpha3DevOpsProject) MarshalJSON() ([]byte, error) {
...
func (o V1alpha3DevOpsProject) ToMap() (map[string]interface{}, error) {
...
type NullableV1alpha3DevOpsProject struct {
	value *V1alpha3DevOpsProject
	isSet bool
}

func (v NullableV1alpha3DevOpsProject) Get() *V1alpha3DevOpsProject {
	return v.value
}

func (v *NullableV1alpha3DevOpsProject) Set(val *V1alpha3DevOpsProject) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha3DevOpsProject) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha3DevOpsProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha3DevOpsProject(val *V1alpha3DevOpsProject) *NullableV1alpha3DevOpsProject {
	return &NullableV1alpha3DevOpsProject{value: val, isSet: true}
}

func (v NullableV1alpha3DevOpsProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha3DevOpsProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
