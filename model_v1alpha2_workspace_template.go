...
// checks if the V1alpha2WorkspaceTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha2WorkspaceTemplate{}

// V1alpha2WorkspaceTemplate struct for V1alpha2WorkspaceTemplate
type V1alpha2WorkspaceTemplate struct {
	...
	Spec *V1alpha2FederatedWorkspaceSpec `json:"spec,omitempty"`
}
...
func NewV1alpha2WorkspaceTemplate() *V1alpha2WorkspaceTemplate {
	this := V1alpha2WorkspaceTemplate{}
	return &this
}
...
func (o *V1alpha2WorkspaceTemplate) GetSpec() V1alpha2FederatedWorkspaceSpec {
	if o == nil || IsNil(o.Spec) {
		var ret V1alpha2FederatedWorkspaceSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given V1alpha2FederatedWorkspaceSpec and assigns it to the Spec field.
func (o *V1alpha2WorkspaceTemplate) SetSpec(v V1alpha2FederatedWorkspaceSpec) {
	o.Spec = &v
}

func (o V1alpha2WorkspaceTemplate) MarshalJSON() ([]byte, error) {
...
func (o V1alpha2WorkspaceTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableV1alpha2WorkspaceTemplate struct {
	value *V1alpha2WorkspaceTemplate
	isSet bool
}

func (v NullableV1alpha2WorkspaceTemplate) Get() *V1alpha2WorkspaceTemplate {
	return v.value
}

func (v *NullableV1alpha2WorkspaceTemplate) Set(val *V1alpha2WorkspaceTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha2WorkspaceTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha2WorkspaceTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha2WorkspaceTemplate(val *V1alpha2WorkspaceTemplate) *NullableV1alpha2WorkspaceTemplate {
	return &NullableV1alpha2WorkspaceTemplate{value: val, isSet: true}
}

func (v NullableV1alpha2WorkspaceTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha2WorkspaceTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
