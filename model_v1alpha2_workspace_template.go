...
type V1alpha2WorkspaceTemplate struct {
	...
	Spec *V1beta1FederatedWorkspaceSpec `json:"spec,omitempty"`
}
...
func (o *V1alpha2WorkspaceTemplate) GetSpec() V1beta1FederatedWorkspaceSpec {
	if o == nil || IsNil(o.Spec) {
		var ret V1beta1FederatedWorkspaceSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given V1beta1FederatedWorkspaceSpec and assigns it to the Spec field.
