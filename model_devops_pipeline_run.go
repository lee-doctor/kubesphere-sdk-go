...
// checks if the DevopsPipelineRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DevopsPipelineRun{}

// DevopsPipelineRun struct for DevopsPipelineRun
type DevopsPipelineRun struct {
	...
	Causes []DevopsPipelineRunCauses `json:"causes,omitempty"`
	// changeset information
	ChangeSet []map[string]interface{} `json:"changeSet,omitempty"`
	CommitId map[string]interface{} `json:"commitId,omitempty"`
...
// SetBranch gets a reference to the given map[string]interface{} and assigns it to the Branch field.
...
func (o *DevopsPipelineRun) GetCauses() []DevopsPipelineRunCauses {
	if o == nil || IsNil(o.Causes) {
		var ret []DevopsPipelineRunCauses
		return ret
	}
	return o.Causes
}
...
// SetCauses gets a reference to the given []DevopsPipelineRunCauses and assigns it to the Causes field.
...
// SetCommitId gets a reference to the given map[string]interface{} and assigns it to the CommitId field.
...
func (o DevopsPipelineRun) MarshalJSON() ([]byte, error) {
...
func (o DevopsPipelineRun) ToMap() (map[string]interface{}, error) {
...
type NullableDevopsPipelineRun struct {
	value *DevopsPipelineRun
	isSet bool
}

func (v NullableDevopsPipelineRun) Get() *DevopsPipelineRun {
	return v.value
}

func (v *NullableDevopsPipelineRun) Set(val *DevopsPipelineRun) {
	v.value = val
	v.isSet = true
}

func (v NullableDevopsPipelineRun) IsSet() bool {
	return v.isSet
}

func (v *NullableDevopsPipelineRun) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDevopsPipelineRun(val *DevopsPipelineRun) *NullableDevopsPipelineRun {
	return &NullableDevopsPipelineRun{value: val, isSet: true}
}

func (v NullableDevopsPipelineRun) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDevopsPipelineRun) UnmarshalJSON(src []byte) error {
	v.isSet = true
