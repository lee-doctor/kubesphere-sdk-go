...
// V1beta1WorkspaceTemplate struct for V1beta1WorkspaceTemplate
type V1beta1WorkspaceTemplate struct {
	...
	Spec *V1beta1WorkspaceTemplateSpec `json:"spec,omitempty"`
}
...
func (o *V1beta1WorkspaceTemplate) GetSpec() V1beta1WorkspaceTemplateSpec {
	if o == nil || IsNil(o.Spec) {
		var ret V1beta1WorkspaceTemplateSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given V1beta1WorkspaceTemplateSpec and assigns it to the Spec field.
